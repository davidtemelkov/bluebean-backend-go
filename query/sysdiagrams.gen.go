...
func (s *sysdiagram) WithContext(ctx context.Context) *sysdiagramDo {
	return s.sysdiagramDo.WithContext(ctx)
}

func (s sysdiagram) TableName() string { return s.sysdiagramDo.TableName() }

func (s sysdiagram) Alias() string { return s.sysdiagramDo.Alias() }
...
func (s sysdiagramDo) Debug() *sysdiagramDo {
	return s.withDO(s.DO.Debug())
}

func (s sysdiagramDo) WithContext(ctx context.Context) *sysdiagramDo {
	return s.withDO(s.DO.WithContext(ctx))
}

func (s sysdiagramDo) ReadDB() *sysdiagramDo {
	return s.Clauses(dbresolver.Read)
}

func (s sysdiagramDo) WriteDB() *sysdiagramDo {
	return s.Clauses(dbresolver.Write)
}

func (s sysdiagramDo) Session(config *gorm.Session) *sysdiagramDo {
	return s.withDO(s.DO.Session(config))
}

func (s sysdiagramDo) Clauses(conds ...clause.Expression) *sysdiagramDo {
	return s.withDO(s.DO.Clauses(conds...))
}

func (s sysdiagramDo) Returning(value interface{}, columns ...string) *sysdiagramDo {
	return s.withDO(s.DO.Returning(value, columns...))
}

func (s sysdiagramDo) Not(conds ...gen.Condition) *sysdiagramDo {
	return s.withDO(s.DO.Not(conds...))
}

func (s sysdiagramDo) Or(conds ...gen.Condition) *sysdiagramDo {
	return s.withDO(s.DO.Or(conds...))
}

func (s sysdiagramDo) Select(conds ...field.Expr) *sysdiagramDo {
	return s.withDO(s.DO.Select(conds...))
}

func (s sysdiagramDo) Where(conds ...gen.Condition) *sysdiagramDo {
	return s.withDO(s.DO.Where(conds...))
}

func (s sysdiagramDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *sysdiagramDo {
	return s.Where(field.CompareSubQuery(field.ExistsOp, nil, subquery.UnderlyingDB()))
}

func (s sysdiagramDo) Order(conds ...field.Expr) *sysdiagramDo {
	return s.withDO(s.DO.Order(conds...))
}

func (s sysdiagramDo) Distinct(cols ...field.Expr) *sysdiagramDo {
	return s.withDO(s.DO.Distinct(cols...))
}

func (s sysdiagramDo) Omit(cols ...field.Expr) *sysdiagramDo {
	return s.withDO(s.DO.Omit(cols...))
}

func (s sysdiagramDo) Join(table schema.Tabler, on ...field.Expr) *sysdiagramDo {
	return s.withDO(s.DO.Join(table, on...))
}

func (s sysdiagramDo) LeftJoin(table schema.Tabler, on ...field.Expr) *sysdiagramDo {
	return s.withDO(s.DO.LeftJoin(table, on...))
}

func (s sysdiagramDo) RightJoin(table schema.Tabler, on ...field.Expr) *sysdiagramDo {
	return s.withDO(s.DO.RightJoin(table, on...))
}

func (s sysdiagramDo) Group(cols ...field.Expr) *sysdiagramDo {
	return s.withDO(s.DO.Group(cols...))
}

func (s sysdiagramDo) Having(conds ...gen.Condition) *sysdiagramDo {
	return s.withDO(s.DO.Having(conds...))
}

func (s sysdiagramDo) Limit(limit int) *sysdiagramDo {
	return s.withDO(s.DO.Limit(limit))
}

func (s sysdiagramDo) Offset(offset int) *sysdiagramDo {
	return s.withDO(s.DO.Offset(offset))
}

func (s sysdiagramDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *sysdiagramDo {
	return s.withDO(s.DO.Scopes(funcs...))
}

func (s sysdiagramDo) Unscoped() *sysdiagramDo {
...
func (s sysdiagramDo) Attrs(attrs ...field.AssignExpr) *sysdiagramDo {
	return s.withDO(s.DO.Attrs(attrs...))
}

func (s sysdiagramDo) Assign(attrs ...field.AssignExpr) *sysdiagramDo {
	return s.withDO(s.DO.Assign(attrs...))
}

func (s sysdiagramDo) Joins(fields ...field.RelationField) *sysdiagramDo {
...
func (s sysdiagramDo) Preload(fields ...field.RelationField) *sysdiagramDo {
	for _, _f := range fields {
