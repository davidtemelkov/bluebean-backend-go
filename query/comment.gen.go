...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.UserID = field.NewInt64(tableName, "UserId")
	_comment.PunchID = field.NewInt64(tableName, "PunchId")
	_comment.CreatedOn = field.NewTime(tableName, "CreatedOn")
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.PunchID = field.NewInt64(table, "PunchId")
	c.CreatedOn = field.NewTime(table, "CreatedOn")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["PunchId"] = c.PunchID
	c.fieldMap["CreatedOn"] = c.CreatedOn
}
